...
class App extends Component {
  render() {
    return (
      ...
      <input type="number" id="number" className="FormField__Input" placeholder="Enter your number" name="number" />
      </div>

      <label className="FormField__CheckboxLabel">
      <input className="FormField__Checkbox" type="checkbox" name="hasAgreed"/> I agree all statements in <a href=" " className="FormField__TermsLink">terms of servise</a>
      </label>
